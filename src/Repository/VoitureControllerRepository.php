...
/**
 * @extends ServiceEntityRepository<VoitureController>
 *
...
class VoitureControllerRepository extends ServiceEntityRepository
{
    ...
    public function save(VoitureController $entity, bool $flush = false): void
    {
    ...
    public function remove(VoitureController $entity, bool $flush = false): void
    {
